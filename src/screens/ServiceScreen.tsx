    ...
    >
      <View style={styles.root}>
        ...
        <View style={styles.locationCard}>
          <Text style={styles.locationTitle}>📍 Find Nearby Services</Text>
          <TextInput
            value={addressInput}
        ...
        <View style={styles.actionRow}>
          <TouchableOpacity style={[styles.actionBtn, styles.actionBtnOutline]} onPress={() => fetchAll()}>
...
const styles = StyleSheet.create({
  ...
  locationActionBtnSecondary: { borderWidth: 1.5, borderColor: '#2563EB', backgroundColor: '#fff' },
  locationActionBtnSecondaryText: { fontSize: 13, color: '#2563EB', fontWeight: '700' },
  locationActionBtnPrimary: { backgroundColor: '#2563EB' },
  ...
  distanceChipActive: { backgroundColor: '#2563EB', borderColor: '#2563EB' },
  ...
  actionBtnFill: { backgroundColor: '#2563EB', shadowColor: '#2563EB', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 3 },
