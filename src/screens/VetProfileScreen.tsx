...
export default function VetProfileScreen({ route, navigation }: any) {
  ...
  const submitPay = async () => {
    const providerId = vet?.userId?._id;
...
const styles = StyleSheet.create({
  ...
  payBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#16A34A', marginHorizontal: 16, marginTop: 12, paddingVertical: 14, borderRadius: 12 },
